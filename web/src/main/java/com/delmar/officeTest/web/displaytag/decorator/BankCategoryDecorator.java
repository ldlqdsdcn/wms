...
public class BankCategoryDecorator implements DisplaytagColumnDecorator {

	private OfficeTestBankService officeTestBankService=EaContext.getBean("OfficeTestBankService", OfficeTestBankService.class);
	/* (non-Javadoc)
	...
	public Object decorate(Object arg0, PageContext arg1, MediaTypeEnum arg2)
		...
		if (arg0 instanceof Integer) {
			...
			OfficeTestBank officeTestBank = officeTestBankService.selectByPrimaryKey(carrierId);
			return	officeTestBank == null ? "" : officeTestBank.getName();
		}
