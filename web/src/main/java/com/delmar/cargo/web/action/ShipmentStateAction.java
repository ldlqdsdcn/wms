 ...
 * @version V2.0
 */
public class ShipmentStateAction  extends CargoCoreAction  {
	...
	{
		return  ResourceMessage.getMessageWithDefault("public.javaaction."+this.getClass().getName(), "CargoPro提单数据统计");
	}
	...
	public String searchs()
	{
		...
		if (mode.equals("")||mode.indexOf("Ocean")>-1)
			list.addAll(searchShipment(orgIds,beGroup,fileNo,flightDateBegin,flightDateEnd,
	 ...
	 */
	private List<BusinessForwarder> searchShipment(String orgIds,String beGroup,String fileNo,String flightDateBegin,String flightDateEnd,
