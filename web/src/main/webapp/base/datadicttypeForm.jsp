...
<s:hidden id="id" name="datadictType.id"></s:hidden>
        ...
        <tr align="center" valign="top"> 
          ...
          <table width="100%" cellpadding="10" cellspacing="0" >
              <tr> 
               ...
               <tr class="query_one">
               		<td style="width:20%" >
               			<s:label for="value" value="%{#session.resource.get('datadictType.column.value')}" ></s:label>
               			</td>
               			<td colspan="3">
               			<s:textfield name="datadictType.value" id="value" readonly="datadictType.id!=null"></s:textfield>
               ...
               <tr  class="query_two">
               	<td width="20%">
               	<s:label for="name" value="%{#session.resource.get('datadictType.column.name')}" ></s:label>
               	</td>
               	<td colspan="3">
               	<s:textfield name="datadictType.name" id="name"></s:textfield>
               	</td>
				</tr>
						...
						<tr  class="query_one">
							...
							<td ><s:label for="descr" value="%{#session.resource.get('datadictType.column.remark')}" ></s:label></td>
							<td colspan="3">
							<s:textfield name="datadictType.remark" id="remark" cssStyle="width:500px;"></s:textfield>
							</td>
