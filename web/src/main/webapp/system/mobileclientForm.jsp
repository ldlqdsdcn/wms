...
<s:hidden id="id" name="mobileClient.id"></s:hidden>
          ...
          <td>
            ...
            <table width="100%" cellpadding="10" cellspacing="0" >
              <tr> 
               ...
               <tr  class="query_one">
               	<td width="20%">
               	<s:label for="versionCode" value="%{#session.resource.get('mobileclient.versionCode')}"  ></s:label>
               	</td>
               	<td colspan="3">
               	<s:textfield name="mobileClient.versionCode" id="versionCode"></s:textfield>
               	</td>
				</tr>
				
				<tr  class="query_two">
				<td ><s:label for="versionName" value="%{#session.resource.get('mobileclient.versionName')}"  ></s:label></td>
							<td colspan="3">
							<s:textfield name="mobileClient.versionName" id="versionName" cssStyle="width:500px;"></s:textfield>
							</td>
							
				</tr>
						<tr  class="query_one">
							
							<td ><s:label for="remark"  value="%{#session.resource.get('javaclass.column.remark')}"  ></s:label></td>
							<td colspan="3">
							<s:textfield name="mobileClient.remark" id="remark" cssStyle="width:500px;"></s:textfield>
							</td>
						</tr>
                ...
                <td colspan="4" class="td_page_right">
						...
						<s:submit method="save" value="%{#session.resource.get('common.button.save')}"  cssClass="input_submit" onclick="return validateData()"></s:submit>
