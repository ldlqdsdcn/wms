...
<s:hidden id="id" name="fileRelation.id"></s:hidden>
<s:hidden  name="fileRelation.delmarFile.id"></s:hidden>
<s:hidden name="fileRelation.fileId"></s:hidden>
          ...
          <td>
            ...
            <table width="100%" cellpadding="10" cellspacing="0" >
              <tr> 
               ...
               <tr  class="query_one">
               	<td width="20%">
               	<s:label for="name" value="文件名"  ></s:label>
               	</td>
               	<td colspan="3">
               	<s:textfield name="fileRelation.delmarFile.filename" id="name" disabled="true"></s:textfield>
               	</td>
				</tr>
				
				<tr  class="query_two">
				<td ><s:label for="pageUrl" value="摘要"  ></s:label></td>
							<td colspan="3">
							<s:textfield name="fileRelation.delmarFile.fileAbstract" id="fileAbstract" cssStyle="width:500px;"></s:textfield>
							</td>
							
				</tr>
						<tr  class="query_one">
							
							<td ><s:label for="descr"  value="关键字"  ></s:label></td>
							<td colspan="3">
							<s:textfield name="fileRelation.delmarFile.fileKeyword" id="remark" cssStyle="width:500px;"></s:textfield>
							</td>
