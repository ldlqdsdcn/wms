              ...
              <tr>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="1" id="formDetail">
                        ...
                        <td width="20%"><s:label for="name" value="名称" ></s:label></td>
                            <td colspan="3">                        <s:textfield name="window.name" id="name"   ></s:textfield>
                          </td>
                        </tr>
                        <tr>
                        <td width="20%"><s:label for="descr" value="描述" ></s:label></td>
                            <td colspan="3">                         <s:textfield name="window.descr" id="descr"  cssStyle="width:500px;" ></s:textfield>
                          </td>
                        </tr>
                        <tr>
                        <td width="20%"><s:label for="help" value="帮助" ></s:label></td>
                            <td colspan="3">                         <s:textfield name="window.help" id="help"  cssStyle="width:500px;" ></s:textfield>
                          </td>
                        </tr>
                    <tr>
                        <td width="20%"><s:label for="createdby" value="创建人" ></s:label></td>
                        <td width="30%">          <delmar:user userId="${window.createdby}" module="user"/>
                        </td>
                    ...
                    <tr>
                        ...
                        <td width="20%"><s:label for="isactive" value="是否有效" ></s:label></td>
                            <td colspan="3">                       <s:radio id="isactive" name="window.isactive" list="#{'Y':'Y','N':'N'}" required="true"></s:radio>
                          </td>
                        </tr>
                <tr>
