...
<body >
<s:form action="meetingParticipant_list" namespace="/core"  theme="simple" >
<table width="100%" border="0" cellspacing="0" cellpadding="5">
<tr>
<td>
    <table border="0" cellpadding="0" cellspacing="0" class="cTableBorder">
        <tr>
            <td align="left" class="navig">位置：参与人</td>
    ...
    <display:table name="sessionScope.MAP_KEY_OF_SESSION.meetingParticipantList" cellspacing="0" cellpadding="0"  requestURI=""
        ...
        <display:column   title="meetingId" sortable="true" media="html">
                 <a href="javascript:viewExport('<c:out value="${list.id}"/>')"><c:out value=" ${list.meetingId}"/></a>
        </display:column>
        <display:column property="meetingId" media="csv excel xml pdf rtf"	title="meetingId" />
        <display:column property="name"  escapeXml="true" title="名称" sortable="true" />
        <display:column property="role"  escapeXml="true" title="role" sortable="true" />
    </display:table>
</td>
</tr>
</table>
...
<script type="text/javascript">
    function viewExport(id) {
       window.location='<c:url value="/core/meetingParticipant_edit.action"/>?id='+id;
    }
