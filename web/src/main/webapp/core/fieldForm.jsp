            ...
            <table width="100%" cellpadding="10" cellspacing="0" >
              <tr>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="1" id="formDetail">
                        ...
                        <td colspan="3"><s:textfield name="field.id" id="id" readonly="true"></s:textfield>
                          </td>
                        </tr>
                        <tr>
                        <td width="20%"><s:label for="name" value="名称" ></s:label></td>
                        <td colspan="3"><s:textfield name="field.name" id="name" readonly="true"></s:textfield>
                          </td>
                        </tr>
                        <tr>
                        <td width="20%"><s:label for="descr" value="描述" ></s:label></td>
                        <td colspan="3"><s:textfield name="field.descr" id="descr" readonly="true"></s:textfield>
                          </td>
                        </tr>
                        <tr>
                        <td width="20%"><s:label for="help" value="帮助" ></s:label></td>
                        <td colspan="3"><s:textfield name="field.help" id="help" readonly="true"></s:textfield>
                          </td>
                        </tr>
                        <tr>
                        <td width="20%"><s:label for="created" value="创建时间" ></s:label></td>
                        <td colspan="3"><s:textfield name="field.created" id="created" readonly="true">
                        ...
                        <td colspan="3"><s:textfield name="field.createdby" id="createdby" ></s:textfield>
                          </td>
                        </tr>
                        <tr>
                        <td width="20%"><s:label for="updated" value="修改时间" ></s:label></td>
                        <td colspan="3"><s:textfield name="field.updated" id="updated" readonly="true">
                        ...
                        <td colspan="3"><s:textfield name="field.updatedby" id="updatedby" readonly="true"></s:textfield>
                          </td>
                        </tr>
                        <tr>
                        <td width="20%"><s:label for="isactive" value="是否有效" ></s:label></td>
                        <td colspan="3"><s:textfield name="field.isactive" id="isactive" readonly="true"></s:textfield>
                          </td>
                        </tr>
                <tr>
