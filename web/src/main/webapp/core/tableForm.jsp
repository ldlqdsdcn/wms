                                                    ...
                                                    <table width="100%" border="0" cellpadding="0" cellspacing="1">
                                                        ...
                                                        <tr>
                                                            <td colspan="2"
                                                                ...
                                                                <input value="<delmar:message key="table.button.addcolumn" />"
                                                                       type="button" class="input_submit"
                                                                       onclick="javascript:addColumn()"/> &nbsp;&nbsp;
                                                                <input class="input_submit" type="button"
                                                                       value="<delmar:message key="table.button.deletecolumn" />"
                                                                       onclick="javascript:deleteColumns()"/>
                                                            </td>
                                                            <td colspan="2"></td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td colspan="4">
                                                                <table id="columnTable" class="table">
                                                                    ...
                                                                    <th width='50px'><delmar:message
                                                                            key="table.label.no"/></th>
                                                                    <th><delmar:message key="table.label.column"/></th>
                                                                    <th><delmar:message
                                                                            key="table.label.columndesc"/></th>
                                                                    <th><delmar:message
                                                                            key="table.label.attributename"/></th>
                                                                    <th><delmar:message key="table.label.type"/></th>
                                                                    <th>
                                                                    ...
                                                                    <s:iterator value="columns" status="st">
                                                                        ...
                                                                        <tr class="<s:property value="#st.index%2==0?'odd':'even'"/>">
                                                                            ...
                                                                            <td>
                                                                                <s:radio
                                                                                        name="%{'columns['+#st.index+'].canShow'}"
                                                                                        list="#{'Y':'Y','N':'N'}"></s:radio>
                                                                            </td>
                                                                            <td>
                                                                                <s:radio
                                                                                        name="%{'columns['+#st.index+'].outLog'}"
                                                                                        list="#{'Y':'Y','N':'N'}"></s:radio>
                                                                            </td>
                                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td colspan="4" class="td_page_right">
                                                                ...
                                                                <input onclick="window.location='<c:url
                                                                        value="/core/table_list.action"/>'"
                                                                       type="button"
                                                                       value="<delmar:message key="common.button.back" />"
                                                                       class="input_submit">
