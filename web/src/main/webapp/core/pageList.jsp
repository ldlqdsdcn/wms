...
<s:form action="page_list" namespace="/core"  theme="simple" >
 ...
 <display:table name="sessionScope.MAP_KEY_OF_SESSION.pageList" cellspacing="0" cellpadding="0"  requestURI=""
		    ...
		    <display:column style="width:30px;text-align:center" title="<input type='checkbox' name='selectall' onClick='selectAll(\"ids\",this);' style='margin:0px;'/>">
            		...
            		<display:column title="序号" media="html csv excel xml pdf rtf">
                           ...
                           <display:column property="windowId"  escapeXml="true" title="windowId" sortable="true"    > </display:column>
                           <display:column property="tableId"  escapeXml="true" title="tableId" sortable="true"    > </display:column>
                           <display:column property="filterColumnId"  escapeXml="true" title="filterColumnId" sortable="true"    > </display:column>
                           <display:column property="isactive"  escapeXml="true" title="是否有效" sortable="true"    > </display:column>
                           <display:column property="showInTab"  escapeXml="true" title="showInTab" sortable="true"    > </display:column>
                           <display:column property="seqNo"  escapeXml="true" title="seqNo" sortable="true"    > </display:column>
                           <display:column property="filterSql"  escapeXml="true" title="filterSql" sortable="true"    > </display:column>
		</display:table>
</td>
</tr>
</table>
