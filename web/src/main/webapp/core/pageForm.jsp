                                        ...
                                        <td>
                                            ...
                                            <table width="100%" border="0" cellpadding="0" cellspacing="1" id="formDetail">
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="30%">
                                                        <s:textfield name="page.created" id="created" readonly="true">
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="30%">
                                                        <delmar:user userId="${page.createdby}" module="user"/>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td width="20%"><s:label for="updated" value="修改时间" ></s:label></td>
                                                    <td width="30%">
                                                        <s:textfield name="page.updated" id="updated" readonly="true">
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="30%">
                                                        <delmar:user userId="${page.updatedby}" module="user"/>
                                                    </td>
                                                </tr>
                                                <tr>
