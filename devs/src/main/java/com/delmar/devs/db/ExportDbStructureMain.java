...
public class ExportDbStructureMain {
    ...
    ExportDbStructureMain(TableService tableService)
    {
    ...
    public static void main(String[] args)
    {
        ...
        ExportDbStructureMain exportDbStructureMain=new ExportDbStructureMain(applicationContext.getBean(TableService.class));
    ...
    private void exportTableDetail(String tableName)
    {
        ...
        {
            ColumnMetaDataDto columnMetaDataDto=columnMetaDataDtoList.get(i);
        ...
        rowNumber++;
        List<UniqueIndexDto> uniqueIndexDtos=tableDao.getUniqueIndex(tableName);
        ...
        rowNumber++;
        for(UniqueIndexDto uniqueIndexDto:uniqueIndexDtos)
        {
        ...
        rowNumber++;
        List<ForeignKey> exportKeys= tableDao.getExportedKeys(tableName);
        ...
        rowNumber++;
        for(ForeignKey foreignKey:exportKeys)
        {
